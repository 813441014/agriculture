...
<div class="x-body">
  <form class="layui-form layui-form-pane" style="margin-left: 20px;">
    ...
    <div class="layui-form-item" style="display: ${strategy}">
      ...
      <div class="layui-input-inline">
        ...
        <input type="text"  id="name" name="name"  lay-verify="name"
               autocomplete="off" class="layui-input" placeholder="字数不能超过20个" maxlength="20" style="width: 473px;">
      </div>
    </div>
    <div class="layui-form-item" style="display: ${success}">
        ...
        <div class="layui-input-inline">
            <input type="text"  id="des" name="des"  lay-verify="des"
    ...
    <div class="layui-form-item" style="display: ${strategy}">
      ...
      <div class="layui-input-block">
        <input type="url" id="url" style="width: 83%" name="url"  lay-verify="${url}"
    ...
    <div class="layui-form-item" style="display: ${strategy}">
     ...
     <div class="layui-form-item">
       ...
       <div class="layui-input-block">
           <select id="status" name="status" lay-verify="" style="width: 83%">
