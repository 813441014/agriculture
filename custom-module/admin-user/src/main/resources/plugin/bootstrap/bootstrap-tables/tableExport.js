      ...
      jspdf: {                          // jsPDF / jsPDF-AutoTable related options
        ...
        autotable: {
          styles: {
            ...
            rowHeight:     12,
            fontSize:      8,
            fillColor:     255,         // Color value or 'inherit' to use nmpocket.css background-color from html table
            textColor:     50,          // Color value or 'inherit' to use nmpocket.css color from html table
            fontStyle:     'normal',    // normal, bold, italic, bolditalic or 'inherit' to use nmpocket.css font-weight and fonst-style from html table
        ...
        loadImages(teOptions, function () {
          $(el).filter(function () {
            ...
            if ( typeof atOptions.createdHeaderCell !== 'function' ) {
              // apply some original nmpocket.css styles to pdf header cells
            ...
            if ( typeof atOptions.createdCell !== 'function' ) {
              // apply some original nmpocket.css styles to pdf table cells
